...
//    private int amount,time,position;
...
//                        BookingItemAdapter.unique=serviceId+userId;
////                        Date today = new Date();
...
//                        editor.apply();
//                        BookingItemAdapter.bookingItemList.remove(position);
